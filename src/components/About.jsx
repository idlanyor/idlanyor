...
const About = () => {
  ...
  const infoCards = [
    ...
    { label: 'Website', value: 'idlanyor.web.id', sub: 'Visit Portfolio', icon: 'fas fa-globe' },
  ];

  return (
    <div className="p-8 clay-panel">
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {infoCards.map((card) => (
            <div key={card.label} className="p-4 clay-card-interactive group">
