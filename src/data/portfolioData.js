...
export const statsData = [
    { icon: '💻', value: '185+', label: 'Repositories' },
    { icon: '⭐', value: '52', label: 'Stars' },
    { icon: '👥', value: '33', label: 'Followers' },
];
...
export const infoCardsData = [
    {
        ...
        title: 'Education',
        subtitle: 'Mahasiswa Semester 4',
        highlight: 'STMIK Widya Utama Purwokerto',
    },
    {
        icon: 'fas fa-briefcase',
        title: 'Work',
        subtitle: 'Freelancer &',
        highlight: 'Graphic Designer',
    },
    {
        icon: 'fas fa-map-marker-alt',
        title: 'Location',
        subtitle: 'Wisesa Karangreja',
        highlight: 'Indonesia',
    },
    {
        icon: 'fas fa-globe',
